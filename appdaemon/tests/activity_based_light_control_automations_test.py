...
def test_turn_on_lights_when_light_automatic_is_disabled():
    # TODO
    assert 4 == 3


def test_turn_on_lights_when_time_dependend_control_is_deactivated():
    # TODO Bypass time constraint and add input boolean switch
    assert 4 == 3
...
def test_turn_on_lights_when_there_is_movement_and_sufficient_lights_but_already_on(given_that, turn_on_lights, assert_that):
